...
def test_category_create_accepts_picker_only_slot_7_to_72() -> None:
    # 7-72 are picker-only (D500) — never auto-assigned, but a valid explicit write.
    created = CategoryCreate(name="Groceries", color_slot=72)

    assert created.color_slot == 72
