...
const en = {
  ...
  // U1.2 (V8) — the tag half of the filter, mirroring the category keys above.
...
const ru: Catalogue = {
  ...
  "expenses.filter.tagOnly": "{tag}",
  "expenses.filter.tagAndPeriod": "{tag} · {period}",
  "expenses.empty.tag": "По тегу {tag} ничего нет.",
  "expenses.empty.tagPeriod": "За {period} по тегу {tag} ничего нет.",
  "expenses.unknownTag": "Неизвестный тег",
  ...
  "statistics.bars.emptyBudget": "Бюджеты не заданы.",
  "statistics.budget.of": "{spent} из {limit}",
  "statistics.budget.exceeded": "Превышение на {amount}",
...
const uk: Catalogue = {
  ...
  "expenses.filter.tagOnly": "{tag}",
  "expenses.filter.tagAndPeriod": "{tag} · {period}",
  "expenses.empty.tag": "За тегом {tag} нічого немає.",
  "expenses.empty.tagPeriod": "За {period} за тегом {tag} нічого немає.",
  "expenses.unknownTag": "Невідомий тег",
  ...
  "statistics.bars.emptyBudget": "Бюджети не задані.",
  "statistics.budget.of": "{spent} з {limit}",
  "statistics.budget.exceeded": "Перевищення на {amount}",
